...
// Добавление набора
//------------------------------------------------------------------------------------------------------
bool RepoMSSQL::AddSetterOut(SetterOut *setter)
{
    bool res;
    QSqlQuery query;
...
void RepoMSSQL::FindModulsStatus(QString serialNumber, QList<Modul> &listModul, int typeStatus)
{
    listModul.clear();
    QSqlQuery query;
    query.prepare("select id,idShipment,idProduct,m_modTypeId,m_name,m_number,m_numberFW,m_dateEnd,m_dateCreate,m_zip "
...
void RepoMSSQL::FindProductStatus(const QString &serialNumber, QList<Product> &listProduct, int status)
{
    listProduct.clear();
    QSqlQuery query;
...
bool RepoMSSQL::UpdateProduct(Product *prod)
{
    bool res;
    QSqlQuery query;
...
//------------------------------------------------------------------------------------------------------
bool RepoMSSQL::AddShipment(Shipment *ship)
{
    bool res;
    QSqlQuery query;
    ...
    query.bindValue(":c_dateOut", ship->dateOut);
...
bool RepoMSSQL::UpdateShipment(Shipment *ship)
{
    bool res;
    QSqlQuery query;
...
bool RepoMSSQL::AddRemontM(RemontM &rem)
{
    ...
    query.prepare("insert into RemontM (ModulId,idReclamation,WorkDate,ReasonId,Action,Defect,Remark) "
                  "output inserted.id values(:ModulId,:idReclamation,:WorkDate,:ReasonId,:Action,:Defect,:Remark)");

    query.bindValue(":ModulId", rem.EntityId);
    query.bindValue(":idReclamation", rem.reclamtionId);
...
bool RepoMSSQL::AddRemontP(RemontM &rem)
{
    ...
    query.prepare("insert into RemontP (ProductId,idReclamation,WorkDate,ReasonId,Action,Defect,Remark) "
                  "output inserted.id values(:ProductId,:idReclamation,:WorkDate,:ReasonId,:Action,:Defect,:Remark)");
...
//------------------------------------------------------------------------------------------------------
void RepoMSSQL::LoadModulToClaim(int idClaim, QList<Modul> &listModul)
{
    listModul.clear();
    QSqlQuery query;
...
void RepoMSSQL::LoadProductToClaim(int idClaim, QList<Product> &listProduct)
{
    listProduct.clear();
    QSqlQuery query;
    query.prepare("select id,idShipment,idSetter,g_ProductTypeId,g_name,g_number,g_numberBox,g_dateRegister,"
...
bool RepoMSSQL::UpdateModul(Modul &modul)
{
    bool res;
    QSqlQuery query;
